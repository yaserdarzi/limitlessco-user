...
//                    $incomeSupplier = $shopping->price_income - $shopping->income - $supplier->price;
//                elseif ($supplier->type == Constants::TYPE_PERCENT)
//                    if ($supplier->percent < 100) {
//                        $incomeSupplier = ($supplier->percent / 100) * ($shopping->price_income);
//                        $incomeSupplier = $shopping->price_income - $incomeSupplier - $shopping->income;
//                    }
